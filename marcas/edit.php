...
<?php
    ...
    if (isset($_GET['id'])) {
        ...
        $res = $mbd->prepare("SELECT id, nombre FROM marcas WHERE id = ?");
        $res->bindParam(1, $id);
        $res->execute();
        $marca = $res->fetch();
...
<body>
    ...
    <div class="container">
        <div class="col-md-6 offset-md-3">
            <h2 class="text-center mt-3 text-primary">Editar Marca</h2>
            ...
            <?php if($marca): ?>
                <form action="" method="post">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="nombre" value="<?php echo $marca['nombre']; ?>" class="form-control" placeholder="Ingrese nombre de la marca">
                    </div>
