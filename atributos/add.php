...
<?php
    ...
    if (isset($_POST['confirm']) && $_POST['confirm'] == 1) {
        ...
        if (!$nombre) {
            ...
            if ($atributo) {
                $msg = 'El atributo ya existe... intente con otro';
            }else{
...
<body>
    ...
    <div class="container">
        <div class="col-md-6 offset-md-3">
            <h1 class="text-center mt-3 text-primary">Nuevo Atributo</h1>
            ...
            <form action="" method="post">
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="nombre" class="form-control" placeholder="Ingrese nombre del atributo">
                </div>
